...
from PyQt5.Qt import QMenu, QToolBar, QAction, QIcon
...
class SemanticSearchInterface(InterfaceAction):
    ...
    action_spec = ('Semantic Search', None,
                   'Search for books and passages by meaning', None)
    ...
    def show_dialog(self):
        ...
        from calibre_plugins.semantic_search.ui.search_dialog import SemanticSearchDialog
    ...
    def index_all_books(self):
        ...
        if not book_ids:
            error_dialog(self.gui, 'Empty Library',
    ...
    def show_indexing_status(self):
        ...
        info_dialog(self.gui, 'Indexing Status',
