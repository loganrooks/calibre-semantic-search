...
class ConfigWidget(QWidget):
    ...
    def _load_settings(self):
        ...
        self.threshold_slider.setValue(int(self.config.get('search_options.similarity_threshold') * 100))
        ...
        self.concurrent_spin.setValue(self.config.get('performance.max_concurrent_requests'))
    ...
    def save_settings(self):
        ...
        self.config.set('search_options.similarity_threshold', self.threshold_slider.value() / 100)
        ...
        self.config.set('performance.max_concurrent_requests', self.concurrent_spin.value())
