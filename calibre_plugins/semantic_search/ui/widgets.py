...
from PyQt5.Qt import (QWidget, QSlider, QLabel, QHBoxLayout, QVBoxLayout,
                      QComboBox, QPushButton, Qt, pyqtSignal, QFrame,
...
class SearchModeSelector(QGroupBox):
    ...
    def _setup_ui(self):
        ...
        modes = [
            ("Semantic", "Find conceptually similar passages", 
             "Best for exploring related ideas and concepts"),
            ("Dialectical", "Find opposing concepts and tensions",
             "Useful for philosophical analysis of contradictions"),
            ("Genealogical", "Trace concept development over time",
        ...
        for i, (mode, short_desc, long_desc) in enumerate(modes):
            ...
            # Connect signal
            radio.toggled.connect(lambda checked, m=mode: 
                                 self.modeChanged.emit(m) if checked else None)
...
class ResultFilterPanel(QFrame):
    ...
    def _setup_ui(self):
        ...
        self.language_combo.addItems(["English", "German", "French", "Spanish", "Latin"])
